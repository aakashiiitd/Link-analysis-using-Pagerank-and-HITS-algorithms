...
with open (csvFilePath) as csvFile:
    ...
    for csvRow in csvReader:
        #s=csvRow.split(',')
        NodeGraph.add_edge(csvRow['Source'],csvRow['Destination'])

hubs, authorities=nx.hits(NodeGraph, max_iter=50, normalized=True)
#print("Hub Scores: ", hubs) 
#print("Authority Scores: ", authorities) 

dd = OrderedDict(sorted(authorities.items(), key=lambda x: x[1]))
